        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectionAddress = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RecyclingStatus = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptedAppliances = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AcceptedAppliances", "Address", "CenterName", "City", "Email", "IsActive", "OperatingHours", "PhoneNumber", "State", "ZipCode" },
                values: new object[,]
                {
                    { 1, "Refrigerators, Washers, Dryers, Dishwashers", "123 Eco Street", "Green Tech Recycling", "Springfield", "info@greentech.com", true, "Mon-Fri 8AM-5PM", "555-0100", "IL", "62701" },
                    { 2, "All major appliances, Small electronics", "456 Recycle Avenue", "Eco Appliance Solutions", "Springfield", "contact@ecoapp.com", true, "Mon-Sat 9AM-6PM", "555-0200", "IL", "62702" }
                });
